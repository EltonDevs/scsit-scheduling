...
interface DeleteTeacherModalProps {
  ...
  dean: Dean | null;
  isLoading: boolean;
  onDelete?: (dean: Dean) => void;
}

export default function DeleteDeanModal({
  isOpen,
  onClose,
  dean,
  onDelete,
  ...
  const handleDelete = () => {
    if (dean && onDelete) {
      console.log("Deleting teacher:", dean.userId);
      onDelete(dean);
    }
    onClose();
  };
      ...
      <div className="text-center animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button
            ...
            aria-label={`Cancel deletion of ${dean.firstName}`}
          >
            Cancel
          </Button>
          <Button
            ...
            aria-label={`Confirm deletion of ${dean.firstName}`}
          >
            Yes, Delete
          </Button>
        </div>
