...
/**
 * Add Schedule Modal
 * - Fully type-safe with DayOfWeek union
 * - Validates dayOfWeek before submission
 * - No createdAt in payload
 */
export default function AddScheduleModal({
  ...
  const [formData, setFormData] = useState<{
    ...
    roomId: string;
    teacherId: string;
    dayOfWeek: DayOfWeek | ""; // allow empty during selection
    startTime: string;
    endTime: string;
  }>({
    subjectId: "",
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // FIXED: Properly handle backend conflict errors
    // console.error("Failed to add schedule:", err);
    
    // Set the error message to display above the form
    setErrors({ 
      submit: err.message || "Failed to create schedule. Please try again." 
    });
  }
  finally {
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h2 id="add-schedule-modal-title" className="text-xl font-bold truncate">
                  Add New Schedule
                </h2>
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        className={`
                          ...
                          text-gray-400 w-full px-3 py-2.5 border rounded-lg text-sm appearance-none
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={handleChange}
                          className={`
                             text-gray-400 w-full px-3 py-2.5 border rounded-lg text-sm
