...
import { deleteDepartment, Department } from "@/services/departmentService";
...
export default function DeleteDepartmentModal({
  ...
  return (
    <Modal
      ...
      aria-describedby="delete-department-modal-description"
    >
      <ErrorModalAlerts
      ...
      <div className="text-center animate-fade-in">
        ...
        <h4
          id="delete-department-modal-title"
        ...
        <p
          id="delete-department-modal-description"
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button
            ...
            aria-label={`Cancel deletion of ${department.name}`}
            disabled={isLoading}
          >
            Cancel
          </Button>
          <Button
            ...
            aria-label={`Confirm deletion of ${department.name}`}
            disabled={isLoading}
          >
            {isLoading ? (
